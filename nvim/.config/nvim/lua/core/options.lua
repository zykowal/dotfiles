...
opt.showcmd = false                                                                                                -- disable showing command in command line
...
opt.foldmethod = "indent"                                                                                          -- Set foldmethod to indent
-- opt.foldexpr = "v:lua.vim.treesitter.foldexpr()"                                                                -- Set foldexpr to treesitter foldexpr(not use treesitter)
